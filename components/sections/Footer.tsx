...
const Footer = () => {
  return (
    <div className="w-full bg-[#d4f7e6] py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header with Logo */}
        <div className="flex justify-center mb-8">
          <div className="w-14 h-14 bg-[#35b48b] rounded-lg flex items-center justify-center">
        ...
        <div className="flex justify-center gap-4 mb-12">
          <div className="w-8 h-8 bg-[#35b48b] rounded-full flex items-center justify-center">
            <Facebook className="w-4 h-4 text-white" />
          </div>
          <div className="w-8 h-8 bg-[#35b48b] rounded-full flex items-center justify-center">
            <MessageCircle className="w-4 h-4 text-white" />
          </div>
          <div className="w-8 h-8 bg-[#d4f7e6] rounded-md"></div>
          <div className="w-8 h-8 bg-[#35b48b] rounded-full"></div>
        </div>
