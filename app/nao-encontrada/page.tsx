      ...
      <div className="text-center max-w-2xl mx-auto px-4">
        ...
        <div className="bg-background rounded-2xl p-8 md:p-12 shadow-[0px_4px_16px_0px_rgba(0,0,0,0.04)]">
          ...
          <div className="mt-8 pt-8 border-t border-gray-100">
            <p className="text-sm text-quaternary mb-4">Precisa de ajuda?</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="https://api.whatsapp.com/send/?phone=5511989705048&text=Ol%C3%A1!%20Preciso%20de%20ajuda%20com%20o%20Celus.%20Por%20favor%2C%20podem%20me%20auxiliar%3F&type=phone_number&app_absent=0"
